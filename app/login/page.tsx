...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-[calc(100dvh-4rem)] items-center justify-center px-4">
      {/* Background glow */}
      <div className="pointer-events-none absolute top-1/4 left-1/2 -translate-x-1/2 h-64 w-64 rounded-full bg-green-300/25 blur-[100px]" />
      ...
      <div className="relative w-full max-w-md rounded-2xl border border-green-100 bg-white p-8 shadow-xl shadow-green-100/50 animate-fade-in-up">
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm text-gray-800 placeholder-gray-400 outline-none transition-colors focus:border-green-400 focus:ring-1 focus:ring-green-400/25"
            />
          </div>
          <div>
        ...
        <p className="mt-6 text-center text-sm text-gray-500">
          ...
          <Link href="/signup" className="font-medium text-green-600 transition-colors hover:text-green-700">
            Sign up
          </Link>
        </p>
      </div>
